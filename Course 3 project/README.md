...
Variable | Description
---------|------------
subjects | Values from 1 to 30 to specify which of the 30 subjects the readings belong to.
activity | Specifies what type of activity the subject was performing to produce the readings.

## List of all the variables as acquired from "featured.txt"
